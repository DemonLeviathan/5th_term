...
int main()
{
	...
	processes[0] = createProcess(L"D:\\Univer\\5-th term\\Labs OS\\LAB_06\\Debug\\OS06_04A.exe").hProcess;
	processes[1] = createProcess(L"D:\\Univer\\5-th term\\Labs OS\\LAB_06\\Debug\\OS06_04B.exe").hProcess;

	//тут указываем сколько будет работать максимум одновременно
