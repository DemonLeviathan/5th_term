...
void printThreadPrty(HANDLE h)
{
    ...
    switch (prty)
    {
        ...
        default:                            std::cout << "----+ priority = " << prty << " \n"; break;
    }
    return;
}
