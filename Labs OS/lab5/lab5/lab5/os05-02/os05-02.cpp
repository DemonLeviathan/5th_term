...
void CreateProccersWithPriority(LPCWSTR an, STARTUPINFO si, int priority)
{
    ...
    if (priority == 2)
    {//	if (CreateProcess(OS03_02_1,NULL,NULL,NULL,FALSE,CREATE_NEW_CONSOLE,NULL,NULL,&si1,&pi1))	
    ...
    {
        {
            ...
            if (argv[1] != NULL)
            {
                ...
                if (argv[2] != NULL)
                {
                    ...
                    CreateProccersWithPriority(L"D:\\Univer\\5-th term\\Labs OS\\lab5\\lab5\\lab5\\Debug\\os05-02x.exe", si, priority);
                    ...
                    if (argv[3] != NULL)
                    {
                        ...
                        ZeroMemory(&si, sizeof(STARTUPINFO));
                        si.cb = sizeof(STARTUPINFO);
                        CreateProccersWithPriority(L"D:\\Univer\\5-th term\\Labs OS\\lab5\\lab5\\lab5\\Debug\\os05-02x.exe", si, priority2);
                    }
