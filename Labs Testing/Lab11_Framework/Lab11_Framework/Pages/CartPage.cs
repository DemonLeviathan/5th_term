...
namespace Lab11_Framework.Pages
{
    public class CartPage : DriverInfo.DriverInfo
    {
        ...
        private readonly By itemquantity =
            By.CssSelector("body > div.page-wrap > section > div > div > div > div > div.panel.has--border > div > div.table--tr.block-group.row--product > div.panel--td.column--quantity.is--align-right > form > select");
